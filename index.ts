...
const LANG_INSTRUCTIONS: Record<string, string> = {
  ...
  fr: "Always respond in FRENCH (Français). Use friendly, clear French. Avoid excessive legal jargon. You specialize in helping Turkish diaspora in France and Belgium.",
  nl: "Always respond in DUTCH (Nederlands). Use friendly, clear Dutch. Avoid excessive legal jargon. You specialize in helping Turkish diaspora in the Netherlands and Belgium.",
};
